                    ...
                    <div class="categori-dropdown-wrap categori-dropdown-active-large">
                        <ul>
                            @foreach ($categories->take(10) as $category)
                                <li
                                    class="{{ $category->children && $category->children->count() ? 'has-children' : '' }}">
                                                ...
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span
                                                                        class="submenu-title">{{ gtrans('Subcategories') }}</span>
                                                                </li>
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item nav-link nav_item"
                                                                            ...
                                                                            @if (isset($child->products_count) && $child->products_count > 0)
                                                                                <span
                                                                                    class="badge bg-light text-dark float-end">{{ $child->products_count }}</span>
                                                                            @endif
                                                                        </a>
                                                                    </li>
                                                                @endforeach
                                                        ...
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span
                                                                        class="submenu-title">{{ gtrans('Explore') }}</span>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item nav-link nav_item"
            ...
            <div class="header-action-right d-block d-lg-none">
                {{-- <div class="header-action-icon-2">
                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#loginModal"
                        ...
                        <img alt="Account" width="20" height="20"
